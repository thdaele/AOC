# https://github.com/wimglenn/advent-of-code-wim/blob/main/aoc_wim/util.py
...
def set_docstrings(files=()):
    ...
    for file in files or here.glob("aoc*/day*.py"):
        day = int(file.name[3:5])
...
def start():
    """init a new source file at ./aocYYYY/dayDD.py"""
    ...
    src = here / f"aoc{year}" / f"day{day:02d}.py"
    block = False
